...
/**
 * Wave P9 follow-up — atajo global a Releases / Roadmap del proyecto activo.
 */
export const dynamic = 'force-dynamic'

export default async function AgileReleasesRedirectPage() {
    ...
    <div className="flex h-full flex-col items-center justify-center p-10">
      <div className="max-w-md rounded-xl border border-dashed border-border bg-card p-8 text-center">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Para planificar Releases necesitas al menos un proyecto en estado
          ACTIVE o PLANNING.
        </p>
        <Link
          href="/projects"
