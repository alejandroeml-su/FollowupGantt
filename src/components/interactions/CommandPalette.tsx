...
function buildActionCommands(router: ReturnType<typeof useRouter>): Cmd[] {
  return [
    ...
    },
    {
      ...
      hint: 'Onboarding',
      onRun: () => useUIStore.getState().toggleOnboardingTour(true),
    },
    {
      ...
      hint: 'Cmd + /',
      onRun: () => useUIStore.getState().toggleSidebarCollapsed(),
    },
    {
      id: 'action:new-task',
      kind: 'action',
      label: 'Nueva tarea',
      hint: 'Cmd + Shift + N',
      onRun: () => useUIStore.getState().requestNewTask(),
    },
    {
      id: 'nav:brain',
      kind: 'action',
    ...
    },
    {
      ...
      onRun: () => router.push('/settings/profile'),
    },
  ]
}
