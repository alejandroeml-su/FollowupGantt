...
/**
 * ProjectDetailClient · Cuerpo client del detalle de proyecto.
 *
 * Wave P6 · Equipo B1.
 *
 * Originalmente todo el detalle vivía en `app/projects/[id]/page.tsx` con
 * `'use client'` en línea 1. Para poder cargar la sesión server-side y
 * hacer drilling de `currentUser` al header de presence (sin volver a
 * pegarle a la cookie desde el cliente), promovemos el `page.tsx` a RSC y
 * extraemos la UI client aquí. Comportamiento UX intacto.
 */
      ...
      <header className="flex-shrink-0 bg-card border-b border-border px-8 py-5">
        ...
        <div className="flex justify-between items-end">
          ...
          <div className="flex gap-2 items-center">
            {/* Wave P6 · Equipo B1 — Presencia en vivo del proyecto. */}
            {currentUser ? (
      ...
      <div className="flex-1 overflow-y-auto p-8">
        {activeTab === 'WBS' && (
          <div className="space-y-6">
            ...
            */}
            <ProjectDocsSection projectId={projectId} />
          </div>
        )}
