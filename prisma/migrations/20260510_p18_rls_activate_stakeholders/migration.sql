-- Wave P18 hardening — Activación incremental RLS restrictivas (Stakeholder).
--
-- Aplica la política `Stakeholder_member_only` y DESACTIVA la
-- open-policy heredada. Tabla con projectId directo.
--
-- Pre-requisito: las server actions de stakeholders.ts deben pasar por
